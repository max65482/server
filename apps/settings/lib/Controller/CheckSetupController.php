...
';
	...
	protected function getOpcacheSetupRecommendations(): array {
		...
		if (!extension_loaded('Zend OPcache')) {
			return [$this->l10n->t('The PHP OPcache module is not loaded. <a target="_blank" rel="noreferrer noopener" class="external" href="%s">For better performance it is recommended</a> to load it into your PHP installation.', [$this->urlGenerator->linkToDocs('admin-php-opcache')])];
		}
